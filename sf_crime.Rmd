...
fit = glm(output ~ Events + Humidity + Conditions + TemperatureF + Tract + DayOfWeek, data = crime.data, family = binomial)
...
plot(density(predicted[actuals == 0]), col="green", main="Double Density Plot")
lines(density(predicted[actuals == 1]), col="red")
